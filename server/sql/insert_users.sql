...
-- Insert into policy
-- This assumes you have the userIds. Adjust the policy details as needed.
INSERT INTO policy (userId, type, address, coordinates) VALUES
((SELECT id FROM users WHERE email = 'conchadetumadress@example.com'), 'Home Insurance', '123 Main St, Anytown, USA', '{"lat": 40.7128, "long": -74.0060}'),
((SELECT id FROM users WHERE email = 'example@example.com'), 'Car Insurance', '456 Elm St, Anycity, USA', '{"lat": 37.7749, "long": -122.4194}');

-- Insert into payment
-- Adjust the payment type to either 'card' or 'wallet'
